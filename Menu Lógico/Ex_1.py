# Exercício 1 da Prova A2 
# Enunciado --> Desenvolvimento de programas para resolver problemas matemáticos básicos (soma, 
...
init()
# Na linha 8 e 9 temos a biblioteca colorama onde permite colorir o texto que será exibido no terminal
# OBS: Caso não tenha a biblioteca instalada coloque o seguinte comando no CMD --> (pip install colorama) aperte ENTER em seguida
#      QUANDO ABRIR O CÓDIGO E GERAR UM ERRO NESSA BIBLIOTECA APENAS FECHE O ARQUIVO E ABRA DENOVO
    ...
    if opcao == "1":
        ...
        while True:
            ...
            if escolha == "1":
                ...
                break
                # Break serve para encerrar o loop atual
                # Nesse caso ele está encerrando o loop do sub-menu e retornando ao menu principal
        ...
        for i in range(1, 11):
            # No range foi definido de 1 até 11, mas no resultado vai de 1 até 10 (sempre colocamos +1 para definir o limite)
            print(num, "x", i, "=", num * i)
